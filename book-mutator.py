...
with file("1000books.csv") as f:
    ...
    for row in bookreader:
        ...
        # remove any wikilink and turn 8-bit funkiness into something that
        # won't make enchant ill
        title = title.split(
            '|')[-1].decode("latin-1").encode("ascii", "ignore")
        ...
        for m in range(0, len(words)):
            ...
            for n in range(0, len(word)):
                ...
                # but enchant pukes on empty strings, and single letters aren't
                # really interesting
